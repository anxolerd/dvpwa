...
async def session_middleware_factory(app, handler):
    ...
    return await middleware(app, handler)


async def csrf_middleware_factory(app, handler):
    """Provides csrf"""

    async def csrf_middleware_handler(request):
    ...
    return csrf_middleware_handler
